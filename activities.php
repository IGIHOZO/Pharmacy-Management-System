...
<head>
  <meta name="description" content="Report -- Pharmacy - Stock Management System by SEVEEEN Ltd " />
  ...
  <title>Pharmacy - Stock Management System | Report</title>
        ...
        <div class="card-body">
          ...
          <div id="tbl_resp">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
 <?php
$sel_pro=mysql_query("SELECT * FROM bms_product_take_out WHERE ktout_product_status='out' AND bms_kt_bus='$all_id' order by ktout_date desc");
...
if (mysql_num_rows($sel_insr_cost)>0) {
  ...
  echo "<center>-<center>";
      ...
      ?></td>
      <td><a style="font-size: 10px;margin-left: -12px" href="libs/parts/tkout_details.php?kkdts=<?php echo $tkdtl;?>" target="_blank" id="prourep"><p><?php echo substr($ft_sel_pro['ktout_date'], 8,2)." / ".substr($ft_sel_pro['ktout_date'], 5,2)." / ".substr($ft_sel_pro['ktout_date'], 0,4)."&nbsp-&nbsp".substr($ft_sel_pro['ktout_date'], 11,5);?>  </p></a></td>
    </tr>
    <?php
