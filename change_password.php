...
<head>
  <meta name="description" content="Change Password -- Pharmacy - Stock Management System by SEVEEEN Ltd " />
  ...
  <title>Pharmacy - Stock Management System | Change Password</title>
...
<body class="bg-dark">
 ...
 <a href="index.php"><span id="home_glyph"><label for="gyl_home">&nbsp&nbspHome</label><span class="glyphicon glyphicon-home" id="gyl_home"></span></span></a>
    <div class="card card-register mx-auto mt-5" style="max-width:500px">
      <div class="card-header"><span id="hd_reg">Change Your Password</span><span id="resp_chg_pss" style="text-align:right;float:right;color:red;font-weight:bold"></span></div>
      <div class="card-body">
          ...
          <button class="btn btn-primary btn-block"  id="ssuubb" onclick="chgPss()"><span class="glyphicon glyphicon-saved"></span>&nbsp&nbsp Change</button>
      </div>
    </div>
<?php
