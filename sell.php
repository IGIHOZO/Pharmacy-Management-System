...
<head>
  <meta name="description" content="Sell Product -- Stock Management System by SEVEEEN Ltd " />
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  <meta http-equiv="X-UA-Compatible" content="IE=9; IE=8; IE=7; IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1">  
  <meta property="fb:pages" content="171343222113" />
  <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
  <title>Stock Management System | Sell Product</title>
...
<body class="bg-dark">
  <div class="container">    
<span id="spn_cntmmn">
 <a style="float: left;margin-left: -80px;margin-top: -35px;" href="index.php"><span id="home_glyph"><label for="gyl_home">&nbsp&nbspHome</label><span class="glyphicon glyphicon-home" id="gyl_home"></span></span></a>

   <a onclick="return receiptOk()"><span id="home_glyph"><label for="gyl_home">&nbsp&nbspReceipt</label><span class="glyphicon glyphicon-print" id="gyl_home"></span></span></a>
</span>

    <div style="position: relative;display: block;" class="card card-register mx-auto mt-5" id="mncntrcpt">
      <div class="card-header"><span id="hd_reg">Take out products </span><span id="resp_tkout"></span></div>
      <div class="card-body">
...
if (mysql_num_rows($sel_ins_csts)>0) {
  ?>
              <div class="col-md-6">
                ...
                <input type="hidden" id="cont_arry_pro">
                <input type="hidden" id="cont_arry_set_tp">
                <input type="hidden" id="cont_arry_qnt">
                <input type="hidden" id="cont_arry_ins">
                </span>
...
?>
          ...
          <button style="width: 80%;position: relative;display: block;" class="btn btn-primary btn-block" id="tkout" onclick="tkOutt()"><span class="glyphicon glyphicon-saved"></span>&nbsp&nbsp Take Out</button>
          <span style="float: right;position: relative;margin-top: -38px;font-weight: bold;">
            <span class="glyphicon glyphicon-ok" id="hideThick"></span>&nbsp;<button onclick="return location.reload(true);" class="btn btn-success glyphicon glyphicon-repeat"> Reset </button>
          </span>
      </div>
    </div>
<table align="center" id="tblle_ctsmr_nm_in">
