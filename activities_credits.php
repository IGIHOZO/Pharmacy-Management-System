...
<head>
  <meta name="description" content="Credits Report -- Pharmacy - Stock Management System by SEVEEEN Ltd " />
  ...
  <title>Pharmacy - Stock Management System | Credits Report</title>
...
<body class="fixed-nav sticky-footer bg-dark" id="page-top">
  <?php require_once("libs/parts/loaderoverlay.php");?>
  <!-- Navigation-->
    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item">
          <a href="#">CREDITS Not yet paid</a>
        </li>

 <li class="breadcrumb-item active" style="font-size: 13px;">See Report On Activity Done On Each Day</li>
        <li><span class="form-inline my-2 my-lg-0 mr-lg-2" id="dte_grp"><div class="input-group"><label for="lblefrom"><b>&nbspChoose Day: &nbsp </b></label><input type="text" name="lblefrom" id="lblefrom" class="form-control" placeholder="Month / Day / Year"><button class="btn btn-primary" id="tke_btn" onclick="datPckrCrdt()"><span class="glyphicon glyphicon-check"></span>&nbsp&nbspTake...</button></div></div></li>
      </ol></div>
        <div class="card-body">
          <div class="table-responsive">
          <div id="resp_crdt_rprt">
              ...
              <tfoot style="font-size: 10px;margin-left: -12px">
                <tr>
                  <th>Creditor</th>
                  <th>Product</th>
                  <th>Unit price</th>
              ...
              <tbody>
 <?php
$sel_pro=mysql_query("SELECT * FROM bms_product_take_out WHERE ktout_product_status='credit' AND bms_kt_bus='$all_id'");
...
if ($cnt_sel_pro>0) {
  ...
  while ($ft_sel_pro=mysql_fetch_assoc($sel_pro)) {
    ...
    <tr>
      ...
      <td style="font-size: 10px;"><?php echo $ft_sel_prn['product_name']?></td>
...
if (mysql_num_rows($sel_insr_cost)>0) {
  ...
  echo "<center>-<center>";
      ...
      ?></td>
      <td style="font-size: 13px"><?php echo substr($ft_sel_pro['ktout_date'], 8,2)."/".substr($ft_sel_pro['ktout_date'], 5,2)."/".substr($ft_sel_pro['ktout_date'], 0,4)."&nbsp-&nbsp".substr($ft_sel_pro['ktout_date'], 11,5);?></td>
      <td><?php if ($ft_sel_pro['ktout_product_status']=="credit") {
        ...
        if (($ft_sel_pro['ktout_product_price']*$ft_sel_pro['ktout_product_quantity'])>$ft_sel_pro['ktout_product_payed']) {
           echo "<a href='libs/parts/credit_payment.php?dreid=$crd_id' target='_blank' class='ntp_crd_pyd'>Not yet</a>";
        }else{
           echo "<a href='libs/parts/credit_payment.php?dreid=$crd_id' class='crd_pyd' target='_blank'>All paid</a>";
        }
      }else{echo "Payed";}?></td>
    </tr>
    <?php
...
?><button class="btn btn-info" style="float:right;margin-top: -3%;" id="prnt_btn" onclick="prntPdf()"><span class="glyphicon glyphicon-print" style="font-size: 20px"></span>&nbsp&nbspPrint PDF</button>
      </div>
    </div>
    <!-- /.container-fluid-->
    <!-- /.content-wrapper-->
