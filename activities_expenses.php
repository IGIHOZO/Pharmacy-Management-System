...
<head>
  <meta name="description" content="Expense Report -- Pharmacy - Stock Management System by SEVEEEN Ltd " />
  ...
  <title>Pharmacy - Stock Management System | Expense Report</title>
        ...
        <div class="card-body">
          ...
          <div id="resp_rprt_expss">
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
<?php
$sel_exp=mysql_query("SELECT * FROM bms_expenses WHERE expense_status='Exp' AND bms_exp_bus='$all_id'")or die(mysql_error());
